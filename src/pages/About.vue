...
<template>
  ...
  <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(../../src/assets/images/page-banner-1.jpg)">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
  ...
  <div id="counter-part" class="bg_cover pt-65 pb-110" data-overlay="8" style="background-image: url(../../src/assets/images/bg-2.jpg)">
    <div class="container">
      <div class="row">
  ...
  <section id="testimonial" class="bg_cover pt-115 pb-120" data-overlay="8" style="background-image: url(../../src/assets/images/bg-2.jpg)">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
  ...
  <div id="patnar-logo" class="pt-40 pb-80 gray-bg">
    <div class="container">
      <div class="row patnar-slied d-flex">
        <div class="col-lg-12">
