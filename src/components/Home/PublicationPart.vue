      ...
      <div class="row align-items-end">
        ...
        <div class="col-lg-6 col-md-4 col-sm-5">
          <div class="products-btn text-right pb-60">
            <PrimaryBtn label="All Products" link="#"/>
          </div> <!-- products btn -->
        </div>
      </div> <!-- row -->
          ...
          <div class="singel-publication mt-30">
            ...
            <div class="cont">
              ...
              <div class="button text-right">
                <PrimaryBtn label="Buy Now ($50)" link="#"/>
              </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-8">
          <div class="singel-publication mt-30">
            ...
            <div class="cont">
              ...
              <div class="button text-right">
                <PrimaryBtn label="Buy Now ($30)" link="#"/>
              </div>
            </div>
          </div> <!-- singel publication -->
        </div>
        <div class="col-lg-3 col-md-6 col-sm-8">
          <div class="singel-publication mt-30">
            ...
            <div class="cont">
              ...
              <div class="button text-right">
                <PrimaryBtn label="Buy Now ($20)" link="#"/>
              </div>
            </div>
          </div> <!-- singel publication -->
        </div>
        <div class="col-lg-3 col-md-6 col-sm-8">
          <div class="singel-publication mt-30">
            ...
            <div class="cont">
              ...
              <div class="button text-right">
                <PrimaryBtn label="Buy Now ($75)" link="#"/>
              </div>
            </div>
          </div> <!-- singel publication -->
        </div>
